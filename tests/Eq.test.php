...
class EqTest extends TestCase
{
    ...
    public function testArrayContainment()
    {
        $arr1 = [
            "field1" => "a",
            "field2" => 3.14,
        ...
        $arr2 = [
            "field1" => "a",
            "field2" => 3.14,
            "field3" => [ "arrkey1" => true, "arrkey2" => "str", "arrkey3" => false ],
            "field4" => (object) [ "innerfield1" => "false", "innerfield2" => 400 ],
            "field5" => new SimpleObject(),
            "field6" => new SimpleObject(),
            "field7" => new SimpleObject()
        ];

        $result = ArrayHelper::equal($arr1, $arr2, [], true);
        $this->assertTrue(is_array($result));
        $this->assertEquals($result[0], ['[field4]', 'innerfield1']);
        ...
        $result = ArrayHelper::equal($arr1, $arr2, [], false);
        $this->assertTrue(is_array($result));
    }
}
